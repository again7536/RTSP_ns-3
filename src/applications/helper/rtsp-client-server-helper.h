 ...
 */
#ifndef RTSP_CLIENT_SERVER_HELPER_H
#define RTSP_CLIENT_SERVER_HELPER_H
...
public:
   ...
   */
  RtspServerHelper (uint16_t port);
   ...
   */
  Ptr<RtspServer> GetServer (void);
private:
  ObjectFactory m_factory; //!< Object factory.
  Ptr<RtspServer> m_server; //!< The last created server application
};
